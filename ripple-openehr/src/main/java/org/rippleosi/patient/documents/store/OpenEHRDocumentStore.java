...
public class OpenEHRDocumentStore extends AbstractOpenEhrService implements DocumentStore {
                ...
                for(int resNoteIndex = 1; resNoteIndex <= numberOfResultNotes; resNoteIndex++){
                    ...
                    switch(type){
                        ...
                        case "pulse" :
                            ...
                            content.put("referral/examination_findings/vital_signs/pulse_heart_beat/pulse_rate|unit", units);
                            break;

                        case "systolic blood pressure" :
                            content.put("referral/examination_findings/vital_signs/blood_pressure/systolic|magnitude", value);
                            content.put("referral/examination_findings/vital_signs/blood_pressure/systolic|unit", units);
                            break;
                        ...
                        case "diastolic blood pressure" :
                            ...
                            content.put("referral/examination_findings/vital_signs/blood_pressure/diastolic|unit", units);
                            break;

                        case "body height" :
                            content.put("referral/examination_findings/height_length/any_event:0/height_length|magnitude", value);
                            content.put("referral/examination_findings/height_length/any_event:0/height_length|unit", units);
                            break;

                        case "weight" :
                            content.put("referral/examination_findings/body_weight/weight|magnitude", value);
                            content.put("referral/examination_findings/body_weight/weight|unit", units);
                            break;

                        case "body mass index" :
                            content.put("referral/examination_findings/body_mass_index/any_event:0/body_mass_index|magnitude", value);
                            content.put("referral/examination_findings/body_mass_index/any_event:0/body_mass_index|unit", units);
                            break;
    ...
    private Map<String,Object> createDischargeFlatJsonContent(DocumentDetails document) {

        final String DISCHARGE_DETAILS_UK_PREFIX = "discharge_summary/discharge_details/discharge_details_uk_v1/";
        final String DISCHARGE_IDENTIFIER_PREFIX = "discharge_summary/context/patient_identifier/";
        ...
        try {
            ...
            content.put(DISCHARGE_DETAILS_UK_PREFIX + "discharge_summary/clinical_summary/clinical_synopsis/synopsis", (String)xPath.compile("//*:NTE/*:NTE.3").evaluate(hl7Document));
